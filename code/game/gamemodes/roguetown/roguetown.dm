...
/datum/game_mode/chaosmode/proc/pick_aspirants()
	var/list/possible_jobs_aspirants = list("Heir", "Successor", "Steward", "Hand")
	var/list/possible_jobs_helpers = list("Heir", "Successor", "Hand",  "Steward", "Knight Lieutenant")
...
/datum/game_mode/chaosmode/proc/pick_maniac()
	restricted_jobs = list("Baron", "Consort")
