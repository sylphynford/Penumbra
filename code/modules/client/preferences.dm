...
//							dat += "| Default: [default_keys.Join(", ")]"
	...
	if(istype(N))
		...
		if(SSticker.current_state <= GAME_STATE_PREGAME)
			...
			// Only show VOYEUR option for admins
...
/datum/preferences/proc/SetChoices(mob/user, limit = 14, list/splitJobs = list("Court Magician", "Knight Banneret", "Priest", "Merchant", "Archivist", "Towner", "Grenzelhoft Mercenary", "Beggar", "Prisoner", "Goblin King"), widthPerColumn = 295, height = 620) //295 620
	if(!SSjob)
		return
