...
/obj/item/clothing/head/roguetown/crown/serpcrown/proc/anti_stall()
	src.visible_message(span_warning("The Crown of Somberwicke crumbles to dust, the ashes spiriting away in the direction of the Keep."))
...
/obj/item/clothing/head/roguetown/helmet/heavy/frogmouth
	...
	desc = "A tall and imposing frogmouth-style helm popular in the highest plateaus of the veil. Covers not just the head, but the neck as well. Add a cloth to show the colors of your family or allegiance."
