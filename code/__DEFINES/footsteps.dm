...
GLOBAL_LIST_INIT(footstep, list(
	FOOTSTEP_WOOD = list(list(
		...
		'sound/foley/footsteps/FTWOO_A4.ogg'), 75, 0),
	FOOTSTEP_FLOOR = list(list(
		...
		'sound/foley/footsteps/FTTIL_A4.ogg'), 75, 0),
	FOOTSTEP_PLATING = list(list(
		...
		'sound/foley/footsteps/FTMET_A4.ogg'), 75, 0),
	...
	FOOTSTEP_WATER = list(list(
		...
		'sound/foley/footsteps/FTWAT_4.ogg'), 75, 0),
	FOOTSTEP_SHALLOW = list(list(
		...
		'sound/foley/footsteps/FTSHAL (5).ogg'), 75, 0),
	...
	FOOTSTEP_STONE = list(list(
		...
		'sound/foley/footsteps/FTROC_A4.ogg'), 75, 0),
	FOOTSTEP_MUD = list(list(
		...
		'sound/foley/footsteps/FTMUD (5).ogg'), 75, 0),
))
