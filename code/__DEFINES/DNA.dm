...
#define MIN_PENIS_INCHES 1.0
#define MAX_PENIS_INCHES 13.5
#define DEFAULT_PENIS_INCHES 6.0

#define PENIS_SPRITE_SMALL 1
#define PENIS_SPRITE_AVERAGE 2
#define PENIS_SPRITE_LARGE 3
#define PENIS_SPRITE_HUGE 4
#define PENIS_SPRITE_MASSIVE 5
#define PENIS_SPRITE_MONSTROUS 6

#define MIN_PENIS_INCHES_TIEFLING 1.0
#define MAX_PENIS_INCHES_TIEFLING 17.5
