...
#define TRAIT_DRUGENHANCER "Drug Enhancer" // drugs last longer

//Hearthstone port (Tracking)
#define TRAIT_PERFECT_TRACKER "Perfect Tracker" //Will always find any tracks and analyzes them perfectly.
#define TRAIT_NOCSIGHT "Blessing of Night" // I can see just a bit more clearly in darkness.
...
#define TRAIT_COMMIE "Blessing of ZIZO" //recognized by bandits as an ally
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_CHOSEN = "PSYDON choose you to represent her glory.",
	...
	TRAIT_DRUGENHANCER = span_info("I know how to get the good stuff."),
))
...
#define TRAIT_STAKED "staked" // Vampire is staked through the heart
