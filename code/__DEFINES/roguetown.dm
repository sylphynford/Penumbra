...
#define ALL_INHUMEN_PATRONS list(/datum/patron/inhumen/zizo, /datum/patron/inhumen/graggar, /datum/patron/inhumen/matthios, /datum/patron/inhumen/baotha, /datum/patron/inhumen/faithless)
...
#define CTAG_ROYALGUARD		"CAT_ROYALGUARD"	// Knight Lieutenant class - Handles Knight Lieutenant class selector
...
#define CTAG_INQUISITOR		"CAT_INQUISITOR"
